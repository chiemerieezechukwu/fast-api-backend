...
def upgrade():
    ...
    op.drop_constraint("match_confirmations_user_id_fkey", "match_confirmations", type_="foreignkey")
    op.create_foreign_key(None, "match_confirmations", "users", ["player_id"], ["id"])
...
def downgrade():
    ...
    op.drop_constraint(None, "match_confirmations", type_="foreignkey")
    op.create_foreign_key("match_confirmations_user_id_fkey", "match_confirmations", "users", ["user_id"], ["id"])
